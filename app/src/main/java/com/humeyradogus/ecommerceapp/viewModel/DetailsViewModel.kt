...
@HiltViewModel
class DetailsViewModel @Inject constructor(private val firebaseAuth: FirebaseAuth,
    ...
    fun addUpdateProductInCart(cartProduct: CartProduct){
        ...
        firestore.collection("user").document(firebaseAuth.uid!!).collection("cart").whereEqualTo("product.id",
        cartProduct.product.id).get().addOnSuccessListener {
            it.documents.let {
