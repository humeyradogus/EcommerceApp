...
import com.humeyradogus.ecommerceapp.databinding.SizeRvItemBinding
...
class SizesAdapter : RecyclerView.Adapter<SizesAdapter.SizesViewHolder>(){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SizesAdapter.SizesViewHolder {
